...
class RAGAgent:
    ...
    def ask(self, question: str) -> dict:
        ...
        agent = Agent(
            role='Classical Ballet Content Assistant',
            goal='Answer questions about classical ballet using the database.',
            backstory='You are an expert who has access to a database with content about classical ballet.',
            tools=[query_tool],
            llm=llm,
