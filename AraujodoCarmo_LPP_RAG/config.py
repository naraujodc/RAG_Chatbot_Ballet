...
DEFAULT_DB_PATH = "backend/ballet_vector.duckdb" # UPDATE WITH YOUR .duckdb file for database.py
...
# Embedding Model
EMBEDDING_MODEL_NAME = "all-MiniLM-L6-v2" # UPDATE TO YOUR MODEL (same model used with duckdb)
EMBEDDING_DIMENSION = 384 # UPDATE TO YOUR MODEL (as seen on HuggingFace for all-MiniLM-L6-v2)